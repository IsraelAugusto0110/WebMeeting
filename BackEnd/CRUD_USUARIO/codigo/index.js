...
function listaUsuarios () {app.get('/usuarios', (req, res) => {
...
function buscaUsuarioPorId () {app.get('/usuarios/:id', (req, res) => {
...
function deletaUsuarioPorId () {app.delete('/usuarios/:id', (req, res) => {
...
function criaNovoUsuario () {app.post('/usuarios', (req, res) => {
    ...
    SET @usuario_perfil = ?; \
    CALL usuarioAdicionarOuEditar(@usuario_id, @usuario_nome, @usuario_email, \
...
function editaUsuario () {app.put('/usuarios', (req, res) => {
    let usuario = req.body;
